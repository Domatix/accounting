...
class abridge_due_report(report_sxw.rml_parse):
    _name = 'report.dx_due_abridge_report.abridge_due_report'

    def __init__(self, cr, uid, name, context):
        super(abridge_due_report, self).__init__(
...
class summary_parser(osv.AbstractModel):
    _name = 'report.dx_due_abridge_report.report_due_list_abridge'
    _inherit = 'report.abstract_report'
    _template = 'dx_due_abridge_report.report_due_list_abridge'
    _wrapped_report_class = abridge_due_report
